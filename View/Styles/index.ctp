<div class="styles index">
	...
	<tr>
		...
		<td><?php echo h($style['Style']['updated']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $style['Style']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $style['Style']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
